 ...
 */
package com.github.commonOkHttp.utils;
...
public class HttpsUtils {
     ...
     * @Description: 创建默认验证方式或者不安全方式的认证
     * @param isUnSafe
     * @return
     */
    ...
    /**
     * @Title: prepareTrustManager
     * @Description: 添加指定证书为信任证书
     * @param certificates
     * @return
     */
